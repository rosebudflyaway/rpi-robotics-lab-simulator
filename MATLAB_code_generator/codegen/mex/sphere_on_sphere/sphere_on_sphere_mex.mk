...
MAKEFILE = sphere_on_sphere_mex.mk

include sphere_on_sphere_mex.mki


SRC_FILES =  \
	sphere_on_sphere_data.c \
	sphere_on_sphere.c \
	Simulator.c \
	Body_sphere.c \
	Body.c \
	sphere_on_sphere_initialize.c \
	sphere_on_sphere_terminate.c \
	sphere_on_sphere_api.c \
	sphere_on_sphere_mex.c

MEX_FILE_NAME_WO_EXT = sphere_on_sphere_mex
...
SYS_INCLUDE += -I "/home/ying/Documents/lockheed/codegen/mex/sphere_on_sphere"
...
%.$(OBJEXT) : /home/ying/Documents/lockheed/codegen/mex/sphere_on_sphere/%.c
	$(CC) $(CCFLAGS) "$<"



%.$(OBJEXT) : /home/ying/Documents/lockheed/codegen/mex/sphere_on_sphere/%.cpp
	$(CXX) $(CPPFLAGS) "$<"
